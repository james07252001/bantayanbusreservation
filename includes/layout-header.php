      ...
      <?php
        if(isset($_SESSION["userId"]) && !empty($_SESSION["userId"])){
            ...
            ?>
              ...
              <li class="nav-item">
              <a class="nav-link" href="/bantayanbus/discount.php"> <i class="fa fa-tags icon w3-large " style="color: black"> <b>Discount</a></b></i>
              </li> 
              <li class="nav-item">
              <a class="nav-link" href="shh.php"> <i class="fa fa-user icon w3-large " style="color: black; font-weight: bold"> <b>User</a></b></i>
              </li> 
              <li class="nav-item">
