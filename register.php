<?php 
    ...
    session_start(); // Make sure session is started if it's used
    ...
    if (isset($_POST["sign-up-submit"])) {
        ...
        $agree_terms = isset($_POST["agree_terms"]);  // Check if the terms checkbox is checked
        
        // Regular expression patterns for validation
        $name_pattern = "/^[a-zA-Z]+$/";
        $address_pattern = "/^[a-zA-Z\s]+$/";
